        ...
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="index.html" class="header-logo">
                    <img src="{{ asset('adminassets/assets/img/brand/logo.png') }}" class="logo-1" alt="logo">
                    <img src="{{ asset('adminassets/assets/img/brand/logo-white.png') }}" class="dark-logo-1"
                        alt="logo">
                </a>
            </div>
                    ...
                    <ul class="nav nav-item  navbar-nav-right ms-auto">
                            ...
                            <div class="dropdown  nav-item countries">
                                ...
                                <div class="dropdown-menu dropdown-menu-start  dropdown-menu-arrow">
                                    <a href="javascript:void(0);" class="dropdown-item d-flex ">
                                        <span class="avatar me-1 align-self-center bg-transparent"><img
                                                src="{{ asset('adminassets/assets/img/flag-imgs/french_flag.jpg') }}"
                                                alt="img"></span>
                                        <div class="d-flex">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item d-flex">
                                        <span class="avatar me-1 align-self-center bg-transparent"><img
                                                src="{{ asset('adminassets/assets/img/flag-imgs/germany_flag.jpg') }}"
                                                alt="img"></span>
                                        <div class="d-flex">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item d-flex">
                                        <span class="avatar me-1 align-self-center bg-transparent"><img
                                                src="{{ asset('adminassets/assets/img/flag-imgs/italy_flag.jpg') }}"
                                                alt="img"></span>
                                        <div class="d-flex">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item d-flex">
                                        <span class="avatar me-1 align-self-center bg-transparent"><img
                                                src="{{ asset('adminassets/assets/img/flag-imgs/russia_flag.jpg') }}"
                                                alt="img"></span>
                                        <div class="d-flex">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item d-flex">
                                        <span class="avatar me-1 align-self-center bg-transparent"><img
                                                src="{{ asset('adminassets/assets/img/flag-imgs/spain_flag.jpg') }}"
                                                alt="img"></span>
                                        <div class="d-flex">
                                ...
                                <div class="menu-header-content bg-primary text-start">
                                    <div class="d-flex">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="badge rounded-pill bg-warning ms-auto my-auto float-end">Mark All
                                            Read</a>
                                    </div>
                                ...
                                <div class="main-message-list chat-scroll">
                                    <div class="p-3 d-flex border-bottom messages">
                                        <div class="  drop-img  cover-image  "
                                            data-bs-image-src="{{ asset('adminassets/assets/img/users/3.jpg') }}">
                                    ...
                                    <div class="p-3 d-flex border-bottom messages">
                                        <div class="drop-img cover-image"
                                            data-bs-image-src="{{ asset('adminassets/assets/img/users/2.jpg') }}">
                                            <span class="avatar-status bg-teal"></span>
                                        </div>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                    ...
                                    <div class="p-3 d-flex border-bottom messages">
                                        <div class="drop-img cover-image"
                                            data-bs-image-src="{{ asset('adminassets/assets/img/users/9.jpg') }}">
                                            <span class="avatar-status bg-teal"></span>
                                        </div>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                    ...
                                    <div class="p-3 d-flex border-bottom messages">
                                        <div class="drop-img cover-image"
                                            data-bs-image-src="{{ asset('adminassets/assets/img/users/12.jpg') }}">
                                            <span class="avatar-status bg-teal"></span>
                                        </div>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                                    ...
                                    <div class="p-3 d-flex border-bottom messages">
                                        <div class="drop-img cover-image"
                                            data-bs-image-src="{{ asset('adminassets/assets/img/users/5.jpg') }}">
                                            <span class="avatar-status bg-teal"></span>
                                        </div>
                                        <div class="wd-90p">
                                            <div class="d-flex">
                        ...
                        @can('الاشعارات')
                            <li class="dropdown nav-item main-header-notification">
                                ...
                                <div class="dropdown-menu">
                                    <div class="menu-header-content bg-primary text-start">
                                        <div class="d-flex">
                                            <h6 class="dropdown-title mb-1 tx-15 text-white fw-semibold">الإشعارات</h6>
                                            <a href="{{ route('admin.invoicesP.MarkAsRead_al') }}"
                                                class="badge rounded-pill bg-warning ms-auto my-auto float-end">قراءة
                                                الكل</a>
                                        </div>
                                        <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="notifications_count">عدد
                                            الإشعارات الغير مقروءة({{ auth()->user()->unreadNotifications->count() }})</p>
                                    </div>
                                                ...
                                                <div class="ms-3">
                                                    <a href="mail.html">
                                                        <h5 class="notification-label mb-1">
                                                            <a
                                                                href="{{ route('admin.invoices.invoicesDetails',$notification->data['id'] ) }}">{{ $notification->data['title'] }}
                        ...
                        <li class="dropdown main-profile-menu nav nav-item nav-link">
                            <a class="profile-user d-flex" href=""><img alt=""
                                    src="{{ asset('adminassets/assets/img/users/6.jpg') }}"></a>
                            <div class="dropdown-menu">
                                <div class="main-header-profile bg-primary p-3">
                                    <div class="d-flex wd-100p">
                                        <div class="main-img-user"><img alt=""
                                                src="{{ asset('adminassets/assets/img/users/6.jpg') }}"
                                                class=""></div>
