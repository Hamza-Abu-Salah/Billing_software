    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="{{ route('admin.invoices_report.Search_invoices') }}" method="POST" role="search" autocomplete="off">
                    @csrf
...
<script src="{{ asset('adminassets/assets/plugins/datatable/js/jquery.dataTables.js') }}"></script>
...
<script src="{{ asset('adminassets/assets/plugins/ion-rangeslider/js/ion.rangeSlider.min.js') }}"></script>
<!--Internal  jquery-simple-datetimepicker js -->
<script src="{{ asset('adminassets/assets/plugins/amazeui-datetimepicker/js/amazeui.datetimepicker.min.js') }}"></script>
<!-- Ionicons js -->
<script src="{{ asset('adminassets/assets/plugins/jquery-simple-datetimepicker/jquery.simple-dtpicker.js') }}"></script>
<!--Internal  pickerjs js -->
<script src="{{ asset('adminassets/assets/plugins/pickerjs/picker.min.js') }}"></script>
