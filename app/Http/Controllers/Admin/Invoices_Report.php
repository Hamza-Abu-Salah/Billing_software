    ...
    public function Search_invoices(Request $request)
    {
        ...
        if ($rdio == 1) {
            ...
            if ($request->type && $request->start_at == '' && $request->end_at == '') {
                ...
                $type = $request->type;
                return view('Admin.reports.invoices_report', compact('type'))->withDetails($invoices);
            }
            ...
            // في حالة تحديد تاريخ استحقاق
                ...
                //whereBetween=>معناها ابحث بين تاريخين
                return view('Admin.reports.invoices_report', compact('type', 'start_at', 'end_at'))->withDetails($invoices);
            }
        }
        ...
        // في البحث برقم الفاتورة
            ...
            return view('Admin.reports.invoices_report')->withDetails($invoices);
        }
    }
}
